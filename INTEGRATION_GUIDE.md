...
### Base URL
```
Production: https://alert-mgmt-system.preview.emergentagent.com/api
...
```bash
curl -X POST https://alert-mgmt-system.preview.emergentagent.com/api/auth/login \
...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://alert-mgmt-system.preview.emergentagent.com/api/companies
```
...
#### Curl Example
```bash
curl -X POST https://alert-mgmt-system.preview.emergentagent.com/api/webhooks/alerts \
  -H "Content-Type: application/json" \
  -d '{
    "company_id": "comp-acme",
...
```
https://alert-mgmt-system.preview.emergentagent.com
```
