...
```
✅ CORRECT: https://alert-realtime.preview.emergentagent.com/api/webhooks/alerts
                                                        ^^^^
```
...
WEBHOOK_URL = "https://alert-realtime.preview.emergentagent.com/api/webhooks/alerts"
...
```
https://alert-realtime.preview.emergentagent.com/api/webhooks/alerts
```

**cURL Example** (CORRECTED):
```bash
curl -X POST "https://alert-realtime.preview.emergentagent.com/api/webhooks/alerts?api_key=aw_7pmImwLYV7IlDEfgIX52G2IHosxnyqELNDdfie2ABn0" \
...
```bash
curl -X POST "https://alert-realtime.preview.emergentagent.com/api/webhooks/alerts?api_key=aw_7pmImwLYV7IlDEfgIX52G2IHosxnyqELNDdfie2ABn0" -H "Content-Type: application/json" -d '{"asset_name":"test-server","signature":"test_alert","severity":"high","message":"Test message","tool_source":"Manual Test"}'
```
